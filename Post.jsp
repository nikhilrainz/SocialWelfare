...
<body>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown"><a href="Registration.jsp" class="effect-3">Register</a></li>
	...
	<div class="inner_sec_grids_info_w3ls">
					<div id="myCarousel" class="team_work_agilepost" data-ride="carousel">
						<h4 class="team_work_agilepost h4"><strong>OBJECTIVE</strong><br><br>
						The objective of the Post Matric Scheme is to award scholarships to meritorious students belonging to economically weaker sections of minority community so as to provide them better opportunities for higher education, increase their rate of attainment in higher education and enhance their employability.
						</h4>
					</div>
	</div>
...
<p align="left" style="color: black;">Admission and tuition fee Class XI & XII: Rs. 7,000/- per annum subject to actuals (both Hosteller & Day Scholar)
									<br>Admission and tuition fee for technical and vocational courses of XI and XII level is Rs.10,000/- per annum subject to actuals (both Hosteller & Day Scholar)</br></p>
<h5 align="left" style="color: red;padding-left: 5px;">Maintenance Allowance</h5>
<p align="left" style="color: black;">For Class XI & XII including Tech. & Voc. Course*: Rs. 380/- per month for Hosteller & Rs. 230/- per month for Day Scholar
									 </p>
