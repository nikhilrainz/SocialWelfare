				...
				<div class="signin-form">
					<div class="login-form-rec">
						<form action="#" method="post">
							<input type="text" name="schemename" placeholder="Enter the Scheme Name" required="">
							<textarea name="schemedesc" placeholder="Enter the Scheme Description" required=""></textarea>
							<div class="tp">
								<a href="AddScheme.jsp"><input type="submit" name= "scheme" value="Add Scheme"></a>
							</div>
						</form>
					</div>
