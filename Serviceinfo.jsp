				...
				<div class="signin-form">
					<div class="login-form-rec">
						...
						<select id="country13" name="cast" onchange="change_country(this.value)" placeholder ="Enter your Cast" class="frm-field required">
							...
							<input type="text" name = "ration" placeholder ="Enter Ration Card Number" onchange = "" required>
							Residential area
							Rural<input type ="radio" name="ef"  value="rural" onchange="" required="" >
							Urban<input type ="radio" name="ef" value="urban" onchange="" required="" >	
							<div class="tp">
...
<% 
	...
	if(submit!=null)
	{
		try
		{
			...
			session.setAttribute("hcenter",Healthcen);
			session.setAttribute("benefit",Benefit);
