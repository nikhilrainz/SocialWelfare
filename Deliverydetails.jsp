				...
				<div class="signin-form">
					<div class="login-form-rec">
						<form action="#" method="post">
							<input type="text" name = "pod" placeholder ="Enter Place of Delivery " onchange="textverify(this)" required>
							<input type="text" name = "ddate" placeholder ="Enter Delivery Date" onchange = "validatedate(this)" required>
							Type of Delivery
