...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
			...
			<div class="tittle_head_w3ls">
				<h3 class="tittle">Delivery Details</h3>
			</div>
		<!---728x90--->
<script src='../../../../../../../publisher.eboundservices.com/dynamicAds/dynamicScript.js'></script>
<div style='margin: 0 auto;text-align: center;margin-top: 5px;'><script>
				...
				<div class="signin-form">
					<div class="login-form-rec">
						<form action="#" method="post" name="myform">
							<input type="text" name = "pod" placeholder ="Enter Place of Delivery " onfocusout = "validateplace(this)" required>
							<p id="pod"></p>
							<input type="text" name = "date" placeholder ="Enter Delivery Date" onfocusout = "validatedate(this)" required>
							<p id="date"></p>
							<p><b> Type of Delivery &nbsp &nbsp </b>
							<input type ="radio" name="dtype"  value="normal" required>&nbsp Normal &nbsp 
							<input type ="radio" name="dtype" value="cesarean" required> &nbsp Cesarean </p>	
							<p><b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Delivery Result &nbsp &nbsp </b>
							<input type ="radio" name="res"  value="surviving" required>&nbsp Surviving Child
							<input type ="radio" name="res" value="dead"  required >&nbsp Dead Child </p>	
							<div class="tp">
...
function validateplace(inp)
{
	...
	{
		pod.style.color='Red';
		document.getElementById("pod").innerHTML="Enter your place of delivery";
		document.myform.pod.focus();
		return false;
	}
}
...
// Match the date format through regular expression
	 ...
	 else
	 {
	  	...
	  	document.getElementById("date").innerHTML = "Enter your Date of Delivery"
	  	document.myform.date.focus();
	  	return false;
	 }
}
