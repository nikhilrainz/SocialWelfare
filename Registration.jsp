...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/14-11-2017/soft-demo_Free/671769136/web/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Aug 2018 04:51:59 GMT -->
				...
				<div class="signin-form">
					<div class="login-form-rec">
						<form action="#" method="post" name = "myform">
							...
							<input type="email" name="email" placeholder="Enter your Email Address" id="mail" onChange="checkEmail(this)" required="">
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
			...
			<div class="tittle_head_w3ls">
				<h3 class="tittle">Applicant Details</h3>
			</div>
		<!---728x90--->
<script src='../../../../../../../publisher.eboundservices.com/dynamicAds/dynamicScript.js'></script>
<div style='margin: 0 auto;text-align: center;margin-top: 5px;'><script>
