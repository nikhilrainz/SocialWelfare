...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
			...
			<div class="tittle_head_w3ls">
				<h3 class="tittle">View Scheme</h3>
			</div>
		<!---728x90--->
<script src='../../../../../../../publisher.eboundservices.com/dynamicAds/dynamicScript.js'></script>
<div style='margin: 0 auto;text-align: center;margin-top: 5px;'><script>
					...
					<div class="login-form-rec">
						<form action="#" method="post" name="myform">
							<table class ="table-striped table-bordered table-condensed table-hover">
								...
								<%
								/*Viewing Schemes based on Category*/
								try
									{
										...
										%>				
											<tr>
												<td><%  c=rs.getString("SchemeId");
														System.out.println("Scheme Id = "+c);
													%>
													<%=rs.getString("SchemeId") %>
												</td>
												<td><%=rs.getString("SchemeName") %></td>
												<td><%=rs.getString("SchemeDesc") %></td>
												<td>
													<%
													/* Query for Apply Buttons */
														Class.forName("com.mysql.jdbc.Driver");
														...
														if(res.next())
														{
															...
															%>	
																...
																<td><a href="ViewUserApplication.jsp?sid=<%=res.getString("SchemeId")%>"><input type = "button" name ="viewuser" id="user" class="btn btn-info" value = "View Application" ></a></td>													
															<% 
															}
															else
															{
