...
<body>
	...
	<div class="header" id="home">
		...
		<div class="inner_sec_grids_info_w3ls">
					<div class="team_work_agileaboutus">
						<h4><u>About Us</u><br><br>
						<p>
						 	Social Welfare Schemes Delivery System  is dedicated to help people find their scholarship opportunities of all kind.
							Social Welfare Schemes Delivery System envisages the development of a new schemes delivery system to enable citizens
							apply for social welfare schemes offered by various Government departments and facilitate electronic transfer 
						 	of the benefits in cash and kind directly to the accounts of these beneficiaries.
						</p>
						</h4>
					</div>
	</div>
