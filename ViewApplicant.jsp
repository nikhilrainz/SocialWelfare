					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li><a href="Deptadmin.jsp" class="effect-3">Home</a></li>
								<li>
									<a href="AddScheme.jsp" class="effect-3" >Add Scheme <b ></b></a>
								</li> 
								<li class="dropdown">
								<li><a href="ViewScheme.jsp" class="effect-3">View Scheme</a></li>	
								<li class="active"><a href="ViewApplicant.jsp" class="effect-3">View Applicant</a></li>
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
			...
			<div class="tittle_head_w3ls">
				<h3 class="tittle">View Applicant</h3>
			</div>
		<!---728x90--->
<script src='../../../../../../../publisher.eboundservices.com/dynamicAds/dynamicScript.js'></script>
<div style='margin: 0 auto;text-align: center;margin-top: 5px;'><script>
							...
							<table class ="table-striped table-bordered table-condensed table-hover">
								...
								<%
									...
									try
									{
										...
										String sqla = "SELECT Category FROM registration where Email = '"+ml+"'";
										ResultSet res = stmt.executeQuery(sqla);
										while(res.next())
										{
										
											cname = res.getString("Category");
											System.out.println("Category = "+cname);
										}
									...
									try
									{
										...
										String sqlb = "SELECT SchemeId,SchemeName FROM studentdepartment where Category = '"+cname+"'";
										ResultSet ress = stmts.executeQuery(sqlb);
										while(ress.next())
										{
										%>
											<tr>
												<td><%=ress.getString("SchemeName") %></td>
												<% 
													if(cname.equals("Education"))
													{
													%>		
														<td><a href="View.jsp?id=<%=ress.getString("SchemeId")%>"><input type = "button" name = "education" class="btn btn-primary" value = "&nbsp View &nbsp"></a></td>
													<% 
													}
													else
													{
