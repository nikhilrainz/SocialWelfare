					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li class="active"><a href="super.jsp" class="effect-3">Home</a></li>
								<li>
									<a href="CreateDepartment.jsp" class="effect-3" >Create Department <b ></b></a>
								</li> 
								<li class="dropdown">
									
								<li><a href="ViewDepartment.jsp" class="effect-3">View Department</a></li>	
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
			...
			<div class="tittle_head_w3ls">
				<h3 class="tittle">View Department</h3>
			</div>
		<!---728x90--->
<script src='../../../../../../../publisher.eboundservices.com/dynamicAds/dynamicScript.js'></script>
<div style='margin: 0 auto;text-align: center;margin-top: 5px;'><script>
						...
						<form action="#" method="post">
							<table border=2>
								...
								try
								{
									...
									String sql = "SELECT * FROM createdepartment";
